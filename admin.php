...
$pageurl = new moodle_url('/local/feedbackdashboard/admin.php');
if ($search !== '') {
    $pageurl->param('search', $search);
}

$PAGE->set_url($pageurl);
$PAGE->set_title(get_string('admindashboardheading', 'local_feedbackdashboard'));
$PAGE->set_heading(get_string('admindashboardheading', 'local_feedbackdashboard'));
