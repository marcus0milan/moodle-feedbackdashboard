...
$string['pluginname'] = 'Dashboard de feedback';
$string['dashboard'] = 'Dashboard';
$string['dashboardtitle'] = 'Dashboard do feedback';
$string['feedbackname'] = 'Pesquisa';
$string['coursename'] = 'Curso';
$string['responsecount'] = 'Respostas enviadas';
$string['questionscount'] = 'Questões';
...
$string['dashboardbutton'] = 'Dashboard NPS';